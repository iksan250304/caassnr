    ...
    <>
      ...
      <div ref={dropdownRef} className="relative">
        <button
          ...
          className="relative flex h-9 w-9 items-center justify-center rounded-full text-ink transition hover:bg-ink/5"
        >
          ...
          {unreadCount > 0 && (
            <span className="absolute right-0.5 top-0.5 flex h-4 min-w-4 items-center justify-center rounded-full bg-press px-1 text-[10px] text-white">
